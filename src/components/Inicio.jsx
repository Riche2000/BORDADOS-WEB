    ...
    <div name='inicio' className='h-screen w-full bg-gradient-to-b from-red-400 via-red to-red-200 pt-24 pb-24'>
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            <div className='flex flex-col justify-center h-full'>
                ...
                <p className='text-stone-100 py-4 max-w-md'>Hacemos cualquier tipo de bordado personalizado para playeras, camisas, sudaderas, suéteres, uniformes, servilletas, toallas y gorras con las mejores prácticas.</p>
                <div>
